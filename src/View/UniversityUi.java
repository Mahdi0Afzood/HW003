        ...
        while (true) {
            ...
            if (inputAll[0].equals("add")) {
                ...
                if (inputAll[1].equals("1")) {
                    ...
                    try {
                        ...
                        System.out.println("Please enter all required data.");
                    } catch (NumberFormatException e) {
                        System.out.println("Please enter data in true formats !");
                    }
                    ...
                    try {
                        ...
                        System.out.println("Please true format int ");
                    }
            ...
            // delete student / clerk / professor / course
                ...
                try {
                    ...
                    System.out.println("please enter true format of data !");
                }
            ...
            // change student / clerk / professor / course
                ...
                try {
                    ...
                    System.out.println("the data entered was not correct format ! ");
                }catch (ArrayIndexOutOfBoundsException e){
                    System.out.println("Sorry ! The method is under destruction ! ");
                }
